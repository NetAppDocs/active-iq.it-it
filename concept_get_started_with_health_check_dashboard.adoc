...
* *AutoSupport Adoption*: Mostra il numero e la percentuale di sistemi con AutoSupport abilitato. Puoi anche visualizzare i sistemi contrassegnati come "Declined", quelli con *HTTPS* e *AutoSupport on Demand* abilitati, così come *Loss of Signal* per quei sistemi che hanno smesso di inviare dati AutoSupport negli ultimi 7 giorni. Per vedere il tuo punteggio del controllo di integrità e le informazioni sui sistemi nella tua base installata, fai clic sul widget *AutoSupport Adoption*.
