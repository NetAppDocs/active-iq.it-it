...
.Fasi
. Nel riquadro a sinistra, seleziona *Consigli per il cloud*.
. Seleziona un qualsiasi collegamento nel riquadro *Migrazione*.
. Seleziona *Migra al cloud* per avviare la *Console*.
...
.Fasi
. Nel riquadro a sinistra, seleziona *Consigli per il cloud*.
. Seleziona un collegamento qualsiasi nel riquadro *Livellamento*.
. Seleziona *Tier Data* per avviare la *Console*.
...
.Fasi
. Nel riquadro a sinistra, seleziona *Consigli per il cloud*.
. Seleziona uno qualsiasi dei collegamenti nel riquadro *Backup & Archive*.
. Seleziona *Backup to Cloud* per avviare la *Console*.
...
.Fasi
. Nel riquadro a sinistra, seleziona *Consigli per il cloud*.
. Seleziona uno qualsiasi dei collegamenti nel riquadro *Ripristino di emergenza*.
. Seleziona *Replica sul cloud* per avviare la *Console*.
