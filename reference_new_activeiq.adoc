...
summary: Scopri le nuove funzionalità e i miglioramenti di Digital Advisor. 
---
...
La sostenibilità è ora supportata sui sistemi E-Series e StorageGRID .  È possibile visualizzare un elenco di azioni consigliate e indicatori ambientali che mostrano proiezioni relative a energia, utilizzo diretto di carbonio e calore dalla dashboard Sostenibilità per questi sistemi. Per saperne di più, fare riferimento alink:https://docs.netapp.com/us-en/active-iq/sustainability-dashboard-overview.html["Panoramica della dashboard Sustainability"^] .
...
* Il flusso di lavoro Benessere ora include il widget Sostenibilità, che fornisce il conteggio delle azioni consigliate a livello di cliente, watchlist, sito e gruppo. Puoi selezionare il numero di azioni per visualizzare nel dettaglio queste azioni consigliate nella dashboard Sostenibilità. Per saperne di più, consulta link:https://docs.netapp.com/us-en/active-iq/learn-about-sustainability.html["Analizza la sostenibilità dei tuoi sistemi storage"].
...
* L'opzione *Salvataggio senza backup snapshot* è stata rinominata in *Con copie snapshot* insieme a una modifica della sua funzionalità. link:https://docs.netapp.com/us-en/active-iq/reference_aiq_faq.html#storage-efficiency["Scopri di più"].
...
La dashboard sulla sostenibilità fornisce informazioni preziose sulla sostenibilità ambientale del tuo sistema di archiviazione.  È possibile visualizzare informazioni quali punteggio di sostenibilità, percentuale di mitigazione del carbonio, utilizzo previsto di energia, emissioni dirette di carbonio e calore.  È possibile regolare la percentuale di mitigazione del carbonio per siti specifici.  È anche possibile visualizzare il punteggio di sostenibilità a livello di cluster.  In base al punteggio di sostenibilità, puoi valutare l'efficienza complessiva del tuo sistema di storage e allinearla alle azioni consigliate da NetApp per migliorare la sostenibilità. link:https://docs.netapp.com/us-en/active-iq/learn-about-sustainability.html["Scopri di più"] .
...
L'efficienza dello storage SAN e NAS è disponibile, a livello di nodo, per i sistemi ONTAP, inclusi AFF A-Series, AFF C190, All SAN Array e FAS500.
...
=== Digital Advisor che si integra con NetApp Console

Active IQ Digital Advisor viene rinominato Digital Advisor ed è ora integrato in NetApp Console, la console di gestione unificata di NetApp per ambienti multicloud ibridi. link:https://docs.netapp.com/us-en/active-iq/digital-advisor-integration-with-console.html["Scopri di più"].
...
Gli utenti della NetApp Console possono ora aprire i link di Digital Advisor in nuove schede, ove applicabile, in modo simile alla funzionalità esistente in Digital Advisor.
...
* Nell'email di Wellness Review, troverai informazioni sulla Ransomware Defense invece che sui Renewals.
...
Selezionando la casella blu "Riepilogo volumi" nella tabella SVM, si apre una finestra a comparsa che visualizza informazioni dettagliate sui volumi ospitati o collegati al numero di serie o al nodo fisico specifico.
...
+
** *Aumento della capacità:* Riceverai una notifica per tutti i siti GRID che superano la soglia del 70% della capacità esistente. Hai la possibilità di aggiungere capacità per gli StorageGRID nel sito, per i prossimi 1, 3 e 6 mesi se è probabile che la soglia di capacità superi il 70%.
** *Rinnovi:* Per tutti i sistemi StorageGRID il cui contratto di licenza è scaduto o sta per scadere nei prossimi 6 mesi, riceverai una notifica. Puoi selezionare uno o più sistemi per inviare una richiesta al team di supporto NetApp per il rinnovo.
...
* *Visualizzatore GRID*: Dal widget *Configurazione*, puoi visualizzare la configurazione GRID in dettaglio selezionando il link *Visualizzatore GRID*. Dal widget *Configurazione*, puoi scaricare i dettagli del sito e i dettagli della capacità per lo StorageGRID selezionando il pulsante *Scarica* nella schermata *Visualizzatore GRID*.
* *Dettagli del sito:* questa scheda fornisce il riepilogo della griglia e i nodi di storage disponibili per ciascun sito.
* *Riepilogo GRID:* Contiene informazioni di base, come License Type, License Capacity, numero di nodi installati, Support Term (Date of termination of license contract), Primary Admin Node e Primary Site del Primary Admin Node. Questa scheda fornisce anche il nome del sito e il numero di storage node associati al sito corrispondente. In questa release, puoi visualizzare l'elenco dei nomi dei nodi selezionando il hyperlink disponibile per visualizzare gli storage node per il sito corrispondente.
...
Il pulsante Tier Data è stato aggiunto alla dashboard di FabricPool e ti permette di suddividere i dati in livelli di storage a oggetti a basso costo usando la NetApp Console.
...
Puoi usare le API di Digital Advisor per estrarre i dati di interesse e integrarli direttamente nel flusso di lavoro della tua azienda. link:https://docs.netapp.com/us-en/active-iq/concept_overview_API_service.html["Scopri di più"].
...
Puoi visualizzare il rapporto di efficienza dello storage e il risparmio del tuo sistema storage con e senza copie snapshot per sistemi AFF, sistemi non AFF o entrambi. Puoi visualizzare le informazioni sull'efficienza dello storage a livello di nodo. link:https://docs.netapp.com/us-en/active-iq/task_analyze_storage_efficiency.html["Scopri come"].
