...
---
= Visualizza lo stato di salute dei cluster e dei nodi utilizzando il widget ClusterViewer in Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
. A livello di cluster o di nodo, seleziona *ClusterViewer* accanto al widget *Configuration*.
. Seleziona la scheda *Visualizzazione* per visualizzare una rappresentazione grafica del cluster.
