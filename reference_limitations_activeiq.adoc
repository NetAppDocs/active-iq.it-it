...
---
= Limitazioni note in Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Nella pagina di segnalazione AutoSupport, selezionando uno qualsiasi degli stati, dei sistemi che hanno smesso di inviare di recente o dei sistemi che hanno AutoSupport disattivato, non si accede alla schermata Health Check.
