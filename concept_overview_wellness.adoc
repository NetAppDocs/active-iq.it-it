...
---
= Scopri di più sul widget benessere in Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Il widget Benessere fornisce informazioni dettagliate sul sistema storage. Offre informazioni su diversi attributi del sistema storage, come prestazioni ed efficienza, capacità, impostazioni di configurazione, vulnerabilità di sicurezza, rinnovi dell'assistenza e altro ancora.
