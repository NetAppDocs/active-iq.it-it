...
---
= Scopri le funzionalità Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
* Visualizza il punteggio di sostenibilità e l'utilizzo previsto di energia, carbonio diretto e calore.  Sulla base del punteggio di sostenibilità, valuta l'efficienza complessiva dei tuoi sistemi di storage e allineati alle azioni consigliate da NetApp per migliorare il punteggio. link:learn-about-sustainability.html["Scopri di più"^] .
* Visualizza il rapporto di riduzione dei dati, lo spazio logico utilizzato, lo spazio fisico utilizzato e la quantità totale di dati salvati.
...
* link:concept_value_insights.html["Scopri Value Insights"]che fornisce informazioni generali sullo stato di salute, sul risparmio, sulla stabilità e sulla sicurezza per il tuo sistema ONTAP.
