...
*Percentuali di mitigazione del carbonio*: Mostra la percentuale di mitigazione del carbonio in ogni sito/città e i valori di riferimento presentati si basano sulla tua posizione. Puoi regolare la percentuale di mitigazione del carbonio per siti specifici selezionando l'icona image:edit_icon_1.png["Una schermata che mostra un'icona modificabile."] accanto ai valori percentuali e i numeri relativi al carbonio si aggiorneranno automaticamente di conseguenza.
