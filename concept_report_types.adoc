...
---
= Scopri di più sui report Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
| Riepilogo esecutivo della valutazione dello stato | Fornisce informazioni su vari KPI di Digital Advisor in formato PowerPoint (PPT), con i diversi KPI descritti in diapositive diverse. | Sì | Sì | No 
...
| Sicurezza | Fornisce una panoramica completa ed esportabile dei rischi per la sicurezza dello storage ONTAP e delle lacune di conformità tra cluster, SVM e volumi. | Sì | No | No 
