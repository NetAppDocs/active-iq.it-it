...
* Assicurarsi che AutoSupport (ASUP) sia abilitato e configurato correttamente e che tutte le sezioni richieste siano incluse. Per maggiori informazioni, vedere link:hhttps://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/ONTAP_AutoSupport_Resolution_Guide["Guida alla risoluzione di ONTAP AutoSupport"].
