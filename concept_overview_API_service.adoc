...
Entrambe le visualizzazioni ti permettono di esplorare gli elementi disponibili usando il riquadro di navigazione a sinistra. Gli elementi sono organizzati per servizio in ordine alfabetico. All'interno di un determinato servizio, puoi espandere l'intestazione per mostrare i singoli endpoint API. Selezionando l'intestazione del servizio o un endpoint API, vai a quella sezione del Catalog nel riquadro centrale.
...
Per informazioni su come accedere e utilizzare le API di Digital Advisor, vedere link:https://docs.netapp.com/us-en/digital-advisor-automation/["NetApp Digital Advisor documentazione API"].
