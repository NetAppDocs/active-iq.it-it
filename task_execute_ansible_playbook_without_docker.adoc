...
---
= Eseguire il playbook Ansible senza l'immagine NetApp Docker
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
----
+
Per ulteriori informazioni sul comando ansible-galaxy, fai riferimento a link:https://docs.ansible.com/projects/ansible/latest/cli/ansible-galaxy.html["Documentazione Ansible Galaxy"^] e per ulteriori informazioni sulla NetApp Ansible Collection, fai riferimento a link:https://galaxy.ansible.com/netapp/ontap["Pagina NetApp Ansible Collection"^].
