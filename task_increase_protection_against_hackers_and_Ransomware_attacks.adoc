...
---
= Rileva i rischi per la sicurezza con Digital Advisor e adotta misure correttive
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
. Seleziona *Azioni* nel widget *Sicurezza e difesa dal ransomware*. image:Security_Image 2 Ransomware attacks.png["Widget Security Vulnerabilities"]
...
. Seleziona la scheda *Rischi specifici* e poi seleziona il collegamento nella colonna *Azioni correttive*. image:Corrective Action_Image 2 Ransomware attacks.png["Colonna azione correttiva"]
+
