...
.Fasi
. Nel widget *Pianificazione*, fai clic su *Espansione dello storage*.
+
...
. Fai clic su *Invia* per inviare la richiesta al team di storage NetApp per ottenere assistenza con l'espansione dello storage per i sistemi selezionati.
