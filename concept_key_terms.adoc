...
---
= Termini e definizioni chiave in Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
** *Risolvi il problema:* Risolve i rischi per il sistema utilizzando Active IQ Unified Manager. Seleziona questo pulsante per avviare Unified Manager ed eseguire i passaggi per mitigare i rischi.
...
* *Widget di pianificazione:* Visualizza informazioni sull'espansione dello storage, sul software e sull'hardware che devono essere rinnovati.
+
** *Espansione dello storage:* Identifica i sistemi che hanno superato o si stanno avvicinando al 90% della capacità e i siti GRID che hanno superato o si stanno avvicinando al 70% della capacità. È possibile inviare una richiesta per aumentare la capacità del proprio sistema storage.
** *Rinnovi dell'assistenza:* Fornisce informazioni sul software e sull'hardware scaduti o in scadenza nei prossimi 6 mesi.
...
* *Efficienza dello storage:* Identifica il rapporto di efficienza dello storage e il risparmio del tuo sistema storage con e senza copie snapshot per sistemi AFF, sistemi non AFF o entrambi.
...
* *Servizi API:* Ti permette di estrarre dati di interesse e integrarli direttamente nel flusso di lavoro della tua azienda.
...
* *Cliente:* Ti permette di visualizzare e gestire la base installata presso i clienti. La Customer Dashboard è il portale centrale di Digital Advisor.
